    ...
    <Container fluid className="my-4">
      <Row>
        <Col>
          ...
          <p className="text-muted">Bienvenido, {currentUser?.name || 'Administrador'}</p>
        </Col>
      </Row>
            ...
            <Col md={3} className="mb-3">
              <Card className="text-center">
                <Card.Body>
                  ...
                  <p className="text-muted mb-0">Ventas Mensuales</p>
                </Card.Body>
              </Card>
            </Col>
            <Col md={3} className="mb-3">
