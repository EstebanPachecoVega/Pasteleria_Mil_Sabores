// Módulo para cargar y gestionar partials con soporte para scripts inline y externos
...
export function preloadPartials() {
    const partials = {
        'header-placeholder': PATHS.PARTIALS.HEADER,
        'navbar-placeholder': PATHS.PARTIALS.NAVBAR,
        'footer-placeholder': PATHS.PARTIALS.FOOTER
    };
